...
class MovieLensDataLoader(object):
    def __init__(self, feature_map, stage="both", 
        ...
        if stage in ["both", "train"]:
            train_gen = SeqDataLoader(feature_map, train_data, user_info, item_info, split="train", batch_size=batch_size,
            ...
            if valid_data:
                valid_gen = SeqDataLoader(feature_map, valid_data, user_info, item_info, split="valid",
        ...
        if stage in ["both", "test"]:
            if test_data:
                test_gen = SeqDataLoader(feature_map, test_data, user_info, item_info, split="test", batch_size=batch_size,
